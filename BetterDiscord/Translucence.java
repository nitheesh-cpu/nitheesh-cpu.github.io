:root {
  --app-bg: url(https://www.wallpapertip.com/wmimgs/44-449128_dark-black-background-mountain.jpg);
  --app-blur: 6px;
  --app-margin: 24px;
  --app-radius: 8px;
  --app-accent: #d73d3d;
...
.border-3dQmSY.speaking-WDn8Wm {
  box-shadow: inset 0 0 0 2px var(--app-accent), inset 0 0 0 3px #000; }
...
/* VOICE CONNECTED -> LISTENING TO SPOTIFY */
.container-3JTnYm {
  padding-right: 16px !important; }

.container-3JTnYm::-webkit-scrollbar {
  width: 0 !important; }
...
[class*="theme-"] .autocomplete-Z9HwQh {
  background-color: transparent;
  border-radius: var(--popout-radius);
  box-shadow: var(--popout-shadow); }
